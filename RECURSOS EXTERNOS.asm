search_slotset:															;ampliar a espacios 1 y 2 los usados en la ram del ordenador
...
setvdp_write: 															;poder escribir en paginas 2 y 3
...
RALENTIZA:																;para ralentizar una secuencia. En RALENTIZADO daremos un valor entre 
...
VEMOS_SI_HAY_INTERRUPCION_DE_LINEA:
...
INTERRUPCION_DE_LINEA_2:
	
		LD A,117															; Metemos lilnea 90 en el registro 19
		OUT (#99),A		
		ld A,19+128		
		out (#99),a		
...
INTERRUPCION_DE_VBLANK_6:
		
	ld		hl,PALETA_DEL_PROTA_MUERTO
	call	SetPalet_sin_retardo

INTERRUPCION_DE_VBLANK_5:
...
LIMPIA_PANTALLA_0_A_3:												;un recuadro en la pantalla 0 de color 0 tapandolo todo_va_bien
...
ESPERA_AL_VDP_HMMC: 													;en hl metemos los datos para los registros hmmc
...
PINTA_DIRECTRICES_DEL_COPY:
		
		jp		HL_DATOS_DEL_COPY_CALL_DOCOPY		

DIRECTRICES_RECTIFICACION_ATAQUE:
...
DIRECTRICES_RECTIFICACION_DEFENSA:
...
copia_numeros_1_a_page_2:	dw	#0000,#0008,#0000,#0108,#002D,#005f
copia_numeros_2_a_page_2:	dw	#00d6,#0008,#00d6,#0108,#002D,#005f
						
POINT_DE_NUMERO:			dw	PINTA_0
							dw	PINTA_1
							dw	PINTA_2
							dw	PINTA_3
							dw	PINTA_4
...
PALETA_DEL_PERGAMINO:		incbin		"PL5/PERGAMINO.PAL"
PALETA_DEL_LABERINTO_1:		incbin		"PL5/FONDO 1.PL5"
PALETA_DEL_LABERINTO_1_D:	incbin		"PL5/FONDO 1 DOBLADA.PL5"
PALETA_DEL_LABERINTO_2:		incbin		"PL5/FONDO 2.PL5"
PALETA_DEL_LABERINTO_3:		incbin		"PL5/FONDO 3.PL5"
PALETA_DEL_POCHADERO:		incbin		"PL5/POCHADERO.PAL"
PALETA_DEL_POCHADERO1:		incbin		"PL5/POCHADERO1.PAL"
PALETA_DEL_POCHADERO4:		incbin		"PL5/POCHADERO4.PAL"
PALETA_DEL_PROTA_MUERTO:	incbin		"PL5/PROTA MUERTO.PAL"
PALETA_DE_MENOS_VIDA:		incbin		"PL5/MENOSVIDA.PAL"
PALETA_DE_ENEMIGO_1:		incbin		"PL5/SPRITES 1.PAL"
